module.exports = {
  ...
  "deploy" : {
    "production" : {
      ...
      "post-deploy" : "ln -nfs /home/ubuntu/apps/demo-dapp/shared/node_modules node_modules && npm install && truffle compile && pm2 startOrRestart ecosystem.config.js --env production"
    }
  }
};
